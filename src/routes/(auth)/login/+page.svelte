        ...
        <div style="opacity: 1; transform: none;">
            ...
            <form class="space-y-4 mt-4" method="POST" use:enhance={() => {
                ...
                <div class="flex items-center justify-between pt-1">
                    <label class="flex items-center gap-2 group min-h-[48px]" for="remember me">
                    ...
                    <a href="/forgot-password" class="text-xs font-bold text-[#1a232e] hover:underline transition-all min-h-[48px] flex items-center">Forgot password?</a>
                </div>
