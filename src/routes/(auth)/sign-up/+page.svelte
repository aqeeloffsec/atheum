    ...
    <div class="w-full max-w-sm">
        <div style="opacity: 1; transform: none;">
            ...
            <div class="space-y-3 mb-5">
                <button type="button" class="flex items-center justify-center cursor-pointer gap-3 w-full py-3 px-4 rounded-[14px] border-2 border-[#e6e0d4] bg-white text-[#1a232e] text-sm font-semibold hover:bg-[#fdfaf6] hover:border-[#1a232e]/30 hover:shadow-sm transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed">
            ...
            <form class="space-y-4 mt-4">
                <div class="space-y-1.5">
                    <label class="text-[11px] font-bold text-gray-500 uppercase tracking-widest" for="name">Full name</label>
                    <div class="relative">
                        ...
                        <input placeholder="Jane Austen" autocomplete="name" class="w-full py-3 rounded-[14px] border bg-[#fdfaf6] text-[#1a232e] text-sm transition-all outline-none placeholder:text-gray-300 pl-10 pr-4 border-[#e6e0d4] focus:border-[#1a232e]/40 focus:ring-2 focus:ring-[#1a232e]/8" type="text" value=""/>
                    </div>
                </div>
                <div class="space-y-1.5">
                    <label class="text-[11px] font-bold text-gray-500 uppercase tracking-widest" for="email">Email address</label>
                    <div class="relative">
                        <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                ...
                <div>
                    <div class="space-y-1.5">
                        <label class="text-[11px] font-bold text-gray-500 uppercase tracking-widest" for="password">Password</label>
                        <div class="relative">
                            <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                            ...
                            <input placeholder="Create a strong password" autocomplete="new-password" class="w-full py-3 rounded-[14px] border bg-[#fdfaf6] text-[#1a232e] text-sm transition-all outline-none placeholder:text-gray-300 pl-10 pr-10 border-[#e6e0d4] focus:border-[#1a232e]/40 focus:ring-2 focus:ring-[#1a232e]/8" type="password" value=""/>
                            <button type="button" class="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors" aria-label="Toggle password visibility">
                ...
                <div class="space-y-1.5">
                    <label class="text-[11px] font-bold text-gray-500 uppercase tracking-widest" for="Confirm password">Confirm password</label>
                    <div class="relative">
                        <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-lock w-4 h-4" aria-hidden="true">
                                <rect width="18" height="11" x="3" y="11" rx="2" ry="2"></rect>
                        ...
                        <input placeholder="Repeat your password" autocomplete="new-password" class="w-full py-3 rounded-[14px] border bg-[#fdfaf6] text-[#1a232e] text-sm transition-all outline-none placeholder:text-gray-300 pl-10 pr-10 border-[#e6e0d4] focus:border-[#1a232e]/40 focus:ring-2 focus:ring-[#1a232e]/8" type="password" value="" />
                        <button type="button" class="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors" aria-label="Toggle password visibility">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye w-4 h-4" aria-hidden="true">
                                <path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                ...
                <div class="space-y-1">
                    <label class="flex items-start gap-2.5 group" for="terms">
                        <input type="checkbox" class="w-4 h-4 rounded border-2 flex items-center focus:ring-0 focus:outline-none checked:bg-[#1a232e] checked:border-[#1a232e] checked:text-white justify-center transition-all shrink-0 mt-0.5 cursor-pointer border-[#c8c0b4] group-hover:border-[#1a232e]/50" />
                ...
                <button type="submit" class="w-full flex items-center cursor-pointer justify-center gap-2.5 bg-[#1a232e] text-white py-3.5 rounded-[14px] font-bold text-sm hover:bg-[#2d3b4b] hover:shadow-lg transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed">Create Library 
            ...
            <p class="flex items-center justify-center gap-1.5 text-[10px] text-gray-400 mt-6">
                ...
                </svg> Your data is encrypted and fully protected
            </p>
        </div>
    </div>
</div>
