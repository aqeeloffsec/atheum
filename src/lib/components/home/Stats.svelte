...
<section bind:this={sectionRef} class="bg-[#1a232e] py-16 overflow-hidden">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
        <div class="stat-item text-center">
            ...
            <p class="stat-number font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">12,400+</p>
        ...
        <div class="stat-item text-center">
            ...
            <p class="stat-number font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">3,800+</p>
        ...
        <div class="stat-item text-center">
            ...
            <p class="stat-number font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">48</p>
            <p class="text-gray-400 text-xs sm:text-sm font-medium">Genres Covered</p>
        </div>
        ...
        <div class="stat-item text-center">
            ...
            <p class="stat-number font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">99%</p>
