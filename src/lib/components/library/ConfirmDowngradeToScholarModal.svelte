    ...
    >
        <div class="p-8">
            <div class="mb-6 text-center">
                ...
                <h3 class="text-2xl font-serif font-bold text-[#1a232e] mb-2">Downgrade to Scholar?</h3>
                <p class="text-gray-500 text-sm">
                    Are you sure you want to downgrade to the Scholar plan? Your book limit will be reduced to 20 books and AI Ebook Generator will be limited to 50 pages.
                </p>
            </div>
