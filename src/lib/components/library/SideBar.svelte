    ...
    <div class="flex flex-col h-full overflow-hidden">
        ...
        <nav class="flex-1 py-6 space-y-1.5 overflow-y-auto {userContext.isSidebarCollapsed ? 'px-4' : 'px-4'}">
            <a 
                ...
                class="flex items-center w-full {userContext.isSidebarCollapsed ? 'justify-center px-0' : 'gap-3 px-4'} py-3 rounded-xl transition-all duration-200 group {(userContext.activeFilter === 'All Books' && page.url.pathname === '/library') ? 'bg-[#fdfaf6] text-[#1a232e]' : 'text-gray-400 hover:text-white hover:bg-white/5'}"
                title="Library"
            >
            ...
            -->
            <!--
            <a href="/library/generate" class="flex items-center w-full gap-3 px-4 py-3 rounded-xl transition-all duration-200 group text-amber-400 hover:text-amber-300 hover:bg-amber-400/10">
            ...
            <a 
                ...
                class="flex items-center w-full {userContext.isSidebarCollapsed ? 'justify-center px-0' : 'gap-3 px-4'} py-3 rounded-xl transition-all duration-200 group {page.url.pathname === '/library/pricing' ? 'bg-[#fdfaf6] text-[#1a232e]' : 'text-gray-400 hover:text-white hover:bg-white/5'}"
                title="Plans & Billing"
            >
