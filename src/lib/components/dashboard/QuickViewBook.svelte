            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="flex-1 space-y-6">
                    ...
                    <div class="pt-6 border-t border-[#e6e0d4] grid grid-cols-1 gap-4">
                        <a href="/dashboard/read/{book.id}" class="flex items-center justify-center gap-3 w-full py-4 px-6 bg-[#1a232e] text-white font-bold rounded-xl transition-all text-sm hover:bg-[#2d3b4b] shadow-lg shadow-[#1a232e]/10 group cursor-pointer">
